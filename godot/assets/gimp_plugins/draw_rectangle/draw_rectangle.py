...
plug_in_proc   = "plug-in-amrmath-py3-rectangle-drawer"
plug_in_binary = "py3-rectangle-drawer"

def draw_rectangle_run(procedure, run_mode, image, drawables, config, data):
  if len(drawables) > 1:
...
class RectangleDrawer (Gimp.PlugIn):
  ...
  def do_create_procedure(self, name):
    ...
    if name == plug_in_proc:
      procedure = Gimp.ImageProcedure.new(self, name,
                                          ...
                                          draw_rectangle_run, None)
      procedure.set_sensitivity_mask (Gimp.ProcedureSensitivityMask.DRAWABLE |
                                      Gimp.ProcedureSensitivityMask.NO_DRAWABLES)
      procedure.set_menu_label("_Python 3 Rectangle Drawer")
      procedure.set_attribution("Amr Muhammad", "Amr Muhammad, AmrMath project", "2025")
      procedure.add_menu_path ("<Image>/Rectangle Drawer")
...
Gimp.main(RectangleDrawer.__gtype__, sys.argv)
