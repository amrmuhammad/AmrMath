...
#define PLUG_IN_PROC "plug-in-amrmath-c-demo-hello-world2"
  ...
  if (g_strcmp0 (name, PLUG_IN_PROC) == 0)
    {
      ...
      gimp_procedure_set_menu_label (procedure, "_C Hello World2");
...
#define PLUG_IN_BINARY "c-hello-world2"
                 ...
                 gpointer              run_data)
{
  ...
  gimp_message ("DEBUG: Hello World2!");
